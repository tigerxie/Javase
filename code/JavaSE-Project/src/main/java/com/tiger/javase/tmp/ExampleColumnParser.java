...
public class ExampleColumnParser extends AbstractColumnParser<List<ColumnChange>> {
    private static final DGELogger logger = User360DGELoggerFactory.getLogger(ExampleColumnParser.class);
    private static Random random = new Random();

    public ExampleColumnParser(FactoryType type) {
        super(type);
    }
